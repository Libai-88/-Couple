const GIT_PUSH_RULES = {
  force: {
    ...
    reason: "Force push is blocked by Couple safety policy.",
  },
  tags: {
    id: "push-tags-blocked",
    reason: "Bulk tag push is blocked by Couple safety policy. Push one explicit tag ref after release review.",
  },
  all: {
    id: "push-all-blocked",
    reason: "Pushing all branches is blocked by Couple safety policy.",
  },
  mirror: {
    id: "push-mirror-blocked",
    reason: "Mirror push is blocked by Couple safety policy.",
  },
};
