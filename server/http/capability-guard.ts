...
import { principalHasScope as principalHasNormalizedScope } from "../../core/security-principal.ts";
import { isLocalOwnerPrincipal, scopeAllows } from "./route-security.ts";
