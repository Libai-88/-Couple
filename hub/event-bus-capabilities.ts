...
export const BUILTIN_EVENT_BUS_CAPABILITIES = Object.freeze([
  {
    ...
    description: "Create a detached Couple session, optionally owned and hidden by a plugin.",
  ...
  },
  {
    type: "session:get",
    title: "Get session",
    description: "Read one Couple session projection by path.",
    inputSchema: {
      type: "object",
      properties: {
  ...
  },
  {
    ...
    description: "Send text into a Couple session on behalf of a plugin.",
    inputSchema: {
      type: "object",
      properties: {
        text: { type: "string" },
  ...
  },
  {
    type: "agent:list",
    title: "List agents",
    description: "List configured Couple agents.",
    inputSchema: {
      type: "object",
      properties: {
        ownerPluginId: { type: "string" },
